...
class SentScreen extends StatelessWidget {
  ...
  Future<List<EmailData>> fetchEmails(BuildContext context, String userId) async {
    final emails = await Provider.of<FirestoreService>(context, listen: false).getEmails(userId, 'sent');
        ...
        return Scaffold(
          ...
          body: FutureBuilder<List<EmailData>>(
            ...
            builder: (context, emailSnapshot) {
              ...
              if (emails.isEmpty) {
                return const Center(child: Text('Không có thư trong mục đã gửi'));
              }
              return Padding(
